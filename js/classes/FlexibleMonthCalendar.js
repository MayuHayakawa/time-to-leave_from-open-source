...
class FlexibleMonthCalendar extends BaseCalendar
{
    ...
    */
    ...
    _initCalendar()
    {
        ...
        // $('.has-clear').on('click', '.clear-text', function(e)
        {
            e.preventDefault();
            console.log('hi');
    ...
    {
        const inputCode = '<input type="time" class="form-text" data-date="' + dateKey + '">';
        const clearButtonCode = '<button class="clear-text material-icons">cancel</button>';
        ...
        return  '<div class="row-time">' +
                    '<div class="ti has-clear" colspan="4">' + inputCode + clearButtonCode + '</div>' +
                '</div>';
    }
    ...
    //     }
    //     return  '<div class="row-time">' +
    //                 '<div class="ti" colspan="4"><input type="time" class="form-text" data-date="' + dateKey + '"><a href="#" class="clear-text material-icons">cancel</a></div>' +
    //             '</div>';
    // }
