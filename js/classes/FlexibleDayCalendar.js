    ...
    _addNecessaryEntries(dateKey, entrySize)
    {
        ...
        function entryPairHTMLCode(entryIndex, isLastRow)
        {
            ...
            return '<div class="row-entry-pair">' +
                    ...
                    '<div class="second-group">' +
                        '<div class="has-clear">' +
                            '<input type="time" class="form-text" data-date="' + dateKey + '">' +
        ...
        // {
        //     const entryPair = $(entryPairHTMLCode(i, i === numberOfPairs));
        //     entriesContainer.append(entryPair);
        //     entryPair.find('.clear-text').on('click', function(e)
        //     {
        //         e.preventDefault();
